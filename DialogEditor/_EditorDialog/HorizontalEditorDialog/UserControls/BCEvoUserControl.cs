...
// ***********************************************************************
// <copyright file="BCEvoUserControl.cs" company="Zeroit Dev Technologies">
...
{
    [ToolboxItem(false)]
    public partial class BCEvoUserControl : UserControl
    {
        public BCEvoUserControl()
        {
            InitializeComponent();
        }
        ...
        private void back_0_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.BCEvoBackColors[0] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_1_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.BCEvoBackColors[1] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_2_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.BCEvoBackColors[2] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_3_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.BCEvoBackColors[3] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_4_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.BCEvoBackColors[4] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_5_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.BCEvoBackColors[5] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void border_0_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.BCEvoBorderColors[0] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void border_1_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.BCEvoBorderColors[1] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void fore_0_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.BCEvoForeColors[0] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void fore_1_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.BCEvoForeColors[1] = color.Color;
                preview.Invalidate();
            }
        }

        private void borderWidth_Numeric_ValueChanged(object sender, EventArgs e)
        {
            preview.BorderWidth = (int)borderWidth_Numeric.Value;
            preview.Invalidate();
        }
    }
}
