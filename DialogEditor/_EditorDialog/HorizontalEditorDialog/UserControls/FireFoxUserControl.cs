...
// ***********************************************************************
// <copyright file="FireFoxUserControl.cs" company="Zeroit Dev Technologies">
...
{
    [ToolboxItem(false)]
    public partial class FireFoxUserControl : UserControl
    {
        public FireFoxUserControl()
        {
            InitializeComponent();
        }
        ...
        private void border_0_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.FireFoxBorderColors[0] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void border_1_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.FireFoxBorderColors[1] = color.Color;
                preview.Invalidate();
            }
        }
