...
// ***********************************************************************
// <copyright file="EmpireUserControl.cs" company="Zeroit Dev Technologies">
...
{
    [ToolboxItem(false)]
    public partial class EmpireUserControl : UserControl
    {
        public EmpireUserControl()
        {
            InitializeComponent();
        }
        ...
        private void back_0_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBackColors[0] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_1_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBackColors[1] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_2_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBackColors[2] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_3_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBackColors[3] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_4_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBackColors[4] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_5_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBackColors[5] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_7_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBackColors[7] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_8_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBackColors[8] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_9_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBackColors[9] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void back_10_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBackColors[10] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void border_0_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBorderColors[0] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void border_1_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBorderColors[1] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void border_2_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBorderColors[2] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void border_3_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBorderColors[3] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void border_4_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireBorderColors[4] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void fore_0_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireForeColors[0] = color.Color;
                preview.Invalidate();
            }
        }
        ...
        private void fore_1_Click(object sender, EventArgs e)
        {
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                preview.EmpireForeColors[1] = color.Color;
                preview.Invalidate();
            }
        }
    }
